...
class AsyncQuerier:
    ...
    async def create_users_table(self) -> None:
        async with self.__pool.acquire() as conn:
            await conn.execute('CREATE TABLE IF NOT EXISTS "users" ("id" INT GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY, "name" VARCHAR(256) NOT NULL, "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP)')
